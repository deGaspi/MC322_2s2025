...
public class BoxedString {
    ...
    private StringBuilder fixSize(String str, int length) {
        str = str.replaceAll("\\R", "");
        StringBuilder strb = new StringBuilder(str);
        if (strb.length() >= length)
            strb.setLength(length);
        else
            strb.append(" ".repeat(length - strb.length()));
        return strb;
    }

    public void appendLine(String str) {
        deque.addLast(fixSize(str, stringLength));
    }
    ...
    public void insertLine(String str) {
        deque.addFirst(fixSize(str, stringLength));
    }
    ...
    public void mergeLines(int mergeAmount, String spacer) {
    ...
    public void addBottom(BoxedString other, HorizontalAlign align) {
        other = other.clone();
        BoxedString smaller = other;
        BoxedString bigger = this;
